...
// ANSWER: Both the space complexities are only dependent on the length of the string.
...
// const factorial4 = new Factorial()
// const factorialFour = new Factorial()
// console.log(`This is the factorial of 4 ${factorial4.calcFac(4)}`)
...
class FiftyPercent{
  ...
  AddFiftyPercent(num) {
    if(this.box.hasOwnProperty(num)){
      return this.box[num] 
    }
    num *= 1.5
    this.box[num] = num
...
let item = new FiftyPercent

console.time("not memoized function time");
console.log(Add50Percent(200))
console.log(Add50Percent(200))
console.log(Add50Percent(200))
console.log(Add50Percent(200))
...
console.log(item.AddFiftyPercent(200))
console.log(item.AddFiftyPercent(200))
console.log(item.AddFiftyPercent(200))
console.log(item.AddFiftyPercent(200))
